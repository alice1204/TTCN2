...
# ==========================================
def get_auth_data():
    print("\n[1/4] 🔧 Sử dụng Key thủ công (Manual Mode)...")
    
    # --- DÁN KEY CỦA BẠN VÀO ĐÂY ---
    # Ví dụ:
    token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlcG9jaCI6MTc2.........." # Token rất dài
    key_b64 = "j9ONifjoKzxt7kmfYTdKK/5vve0b9Y1UCj/n50jr8d8=" # Ví dụ
    nonce_b64 = "Ipp9HNSfVBUntqFK7PrtofYaOPV312xy"           # Ví dụ
    # -------------------------------

    # Cookie giả (đôi khi không cần nếu dùng Token cứng, nhưng tốt nhất cứ lấy từ trình duyệt nếu được)
    # Hoặc để trống {} cũng được nếu Token còn mới
    cookies = {} 
    
    return token, key_b64, nonce_b64, cookies
